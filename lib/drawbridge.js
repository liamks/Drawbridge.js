...
util.inherits(DrawBridge, events.EventEmitter);
...
DrawBridge.prototype.getUser = function( obj, cb ){
  if( obj.email ){
    _this.db.findUserByEmail( obj.email, cb );
  }else if( obj.screenName ){
    _this.db.findUserByScreenName( obj.screenName, cb );
  }else{
...
DrawBridge.prototype.changeUsersAttributes = function( email, obj, cb ){
  _this.db.changeUsersAttributes( email, obj, cb );
}
