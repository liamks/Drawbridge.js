...
CPPPATH_NODE = '/usr/local/Cellar/node/0.6.15/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
HAVE_RAND_BYTES = ()
LIBDIR = '/Users/ldk/.node_libraries'
LIBPATH_NODE = '/usr/local/Cellar/node/0.6.15/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/ldk/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.6.15'
